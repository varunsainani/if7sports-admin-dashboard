...
export const canchas: Cancha[] = [
  {
    ...
    precioBase: 24,
    estado: 'activa',
    imagenes: ['/imagenes/padel-1.svg', '/imagenes/padel-2.svg'],
  ...
  },
  {
    ...
    precioBase: 45,
    estado: 'activa',
    imagenes: ['/imagenes/futbol7-norte.svg'],
    diasAbiertos: [1, 2, 3, 4, 5, 6, 7],
    horaApertura: '09:00',
    horaCierre: '23:00',
    reglasPrecio: [
  ...
  },
  {
    ...
    precioBase: 45,
    estado: 'activa',
    imagenes: ['/imagenes/futbol7-sur.svg'],
    diasAbiertos: [1, 2, 3, 4, 5, 6, 7],
    horaApertura: '09:00',
    horaCierre: '23:00',
    reglasPrecio: [
  ...
  },
  {
    ...
    precioBase: 95,
    estado: 'activa',
    imagenes: ['/imagenes/campo-principal.svg', '/imagenes/polideportivo-pistas.svg'],
    diasAbiertos: [1, 2, 3, 4, 5, 6, 7],
    horaApertura: '09:00',
    horaCierre: '22:00',
  ...
  },
  {
    ...
    precioBase: 38,
    estado: 'activa',
    imagenes: ['/imagenes/pabellon.svg'],
    diasAbiertos: [1, 2, 3, 4, 5, 6, 7],
    horaApertura: '08:00',
    horaCierre: '23:00',
    reglasPrecio: [
